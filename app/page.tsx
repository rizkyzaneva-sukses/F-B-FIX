...
export default function Home() {
  ...
  const fillDummyData = async () => {
    ...
    setProducts(initialProducts); setMaterials(initialMaterials); setReceivables(initialReceivables); setExpenses(initialExpenses); setPurchases(initialPurchases); setPayables(initialPurchases); setBatches(initialBatches); setCapitalEntries(initialCapital); setSales(initialSales); setSalesCount(38); setCart([]);
